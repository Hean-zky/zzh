...
主页地址：<https://hean-zky.github.io/zzh/>

打开 `index.html` 即可预览主页；GitHub Pages 可直接使用 `main` 分支根目录部署。

Lirael 是中国科学院大学流体力学专业在读博士，还在努力学习中。这里记录个人介绍、项目经历、实物样机、模型档案和正在开发中的想法。

联系方式：`13371578767@163.com`

主页整合了 `头像.jpg`、`图片展示`、`实物展示` 和 `第一版-最终版本-step` 四类资料。SolidWorks 2026 版本的装配体和零件源文件请前往：[AIChongZhi/mltwq](https://github.com/AIChongZhi/mltwq)

![Lirael 个人主页项目展示](实物展示/全景正面.jpg)

## 主页结构

- 关于我：个人介绍、研究方向和联系方式
- 项目经历：点击猫粮投喂器项目卡片查看详细介绍
- 实物展播：项目详情中自动轮播 8 张实物照片
- 开发状态：展示正在努力开发中的下一个项目

主页采用个人项目档案式组织，并加入日间/夜间主题切换、项目详情弹窗和自动照片展播。欢迎各位老师、同学和朋友指导交流。
