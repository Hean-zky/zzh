...
> 个人项目主页：结构、传动、实物样机和模型档案。

主页地址：<https://hean-zky.github.io/zzh/>

打开 `index.html` 即可预览主页；GitHub Pages 可直接使用 `main` 分支根目录部署。

这里是 Hean-zky 的猫粮投喂器个人项目主页，包含项目介绍、工作原理、实物样机记录、STEP 模型下载和展示图片。本仓库用于模型查看、结构展示和通用 CAD 格式共享，不包含 SolidWorks 源文件。

主页整合了 `图片展示`、`实物展示` 和 `第一版-最终版本-step` 三类资料。SolidWorks 2026 版本的装配体和零件源文件请前往：[AIChongZhi/mltwq](https://github.com/AIChongZhi/mltwq)

![猫粮投喂器实物展示](实物展示/全景正面.jpg)

## 主页结构

- 项目：实物样机与完整三维模型
- 原理：定时投喂的五步传动过程和摄像头功能
- 档案：STEP 总装、零件下载和源文件仓库入口
- 实物记录：拆解、传动和喂食组件照片

主页样式参考了个人项目档案/数据库式作品集的组织方式，并加入日间/夜间主题切换和图片放大查看。
